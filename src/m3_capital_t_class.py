    ...
    *** See the PDFs, especially dimensions.pdf, to help you understand this.
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        *** See   dimensions.pdf   to understand the following! ***
        ...
        # ---------------------------------------------------------------------
        horizontalx1 = intersection_center.x - (width/2)
        horizontaly1 = intersection_center.y + (letter_thickness/2)
        horizontalx2 = intersection_center.x + (width / 2)
        horizontaly2 = intersection_center.y - (letter_thickness / 2)
        verticalx1 = intersection_center.x - (letter_thickness/2)
        verticaly1 = intersection_center.y - (letter_thickness/2)
        verticalx2 = intersection_center.x + (letter_thickness/2)
        verticaly2 = verticaly1 + height
        self.h_rect = rg.Rectangle(rg.Point(horizontalx1,horizontaly1),rg.Point(horizontalx2,horizontaly2))
        self.v_rect = rg.Rectangle(rg.Point(verticalx1,verticaly1), rg.Point(verticalx2,verticaly2))
    ...
    def clone(self):
        ...
        #######################################################################
        newT = CapitalT(self.h_rect.get_center(), (self.h_rect.corner_2.x-self.h_rect.corner_1.x), (self.v_rect.corner_2.y-self.v_rect.corner_1.y), (self.h_rect.corner_2.y-self.h_rect.corner_1.y))
